...
* @Time 2023/7/7 15:27
*/
class HomeAnimeFilterSheet extends StatefulWidget {
  // 已选择的过滤条件
  final List<FilterSelect> selectFilters;

  const HomeAnimeFilterSheet({
    super.key,
  ...
  @override
  State<HomeAnimeFilterSheet> createState() => _HomeAnimeFilterSheetState();
}

class _HomeAnimeFilterSheetState extends State<HomeAnimeFilterSheet> {
  // 选择数据回调
